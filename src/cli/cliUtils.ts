...
import { Feature, FeatureConfiguration, getAllFeatures, getFeature, getFeatureConfigurations } from "./featuresCLIController";
import { Variable, getAllVariables, getVariable } from "./variablesCLIController";
...
export const getCombinedVariableDetails = async (variable: string | Variable) => {
